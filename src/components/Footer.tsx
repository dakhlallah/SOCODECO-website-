...
const footerLinks = {
  services: [
    ...
    { name: "Metal & Steel Construction", href: "/services#metal-construction" },
    { name: "Facades & Cladding", href: "/services#facades" },
    { name: "Building Information Modelling", href: "/services#bim" },
  ],
  company: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-[var(--text-muted)] text-sm leading-relaxed">
              Delivering engineering excellence across the Democratic Republic of Congo
              and Lebanon. From residential developments to industrial facilities,
              we construct the infrastructure of tomorrow.
            </p>
          ...
          {/* Services */}
          <div>
            <h4 className="font-display text-xl text-[var(--text)] mb-4">Services</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="font-display text-xl text-[var(--text)] mb-4">Company</h4>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <div className="space-y-4 font-mono text-sm">
              <div>
                <p className="text-[var(--accent)] mb-1">Congo DRC</p>
              ...
              <div>
                <p className="text-[var(--accent)] mb-1">Lebanon</p>
                <p className="text-[var(--text-muted)]">
                  456 Rue Hamra
                  <br />
                  Beirut, Lebanon
      ...
      <div className="border-t border-[var(--surface-light)] px-4 md:px-8 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-mono text-xs text-[var(--text-muted)]">
            © {new Date().getFullYear()} SOCODECO. All rights reserved.
          </p>
