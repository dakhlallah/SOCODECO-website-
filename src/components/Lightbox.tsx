      ...
      {image && (
        ...
        >
          <button
            ...
            onClick={onClose}
            className="absolute right-5 top-5 z-10 grid h-12 w-12 place-items-center rounded-full border border-white/20 text-white/80 transition-all duration-300 hover:rotate-90 hover:border-rouge hover:text-rouge"
          >
            <X size={20} />
          </button>
          <motion.figure
